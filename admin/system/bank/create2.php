    ...
    <div class="tab-content">
        <div id="step1" class="p-m tab-pane active">
            <div class="row">
                ...
                <div class="form-group col-lg-4">
                    <label>Escola:</label>
                    <select  class="form-control"  name="data_bank_school" required>
                        ...
                        if ($readSchool->getResult()):
                            foreach ($readSchool->getResult() as $school):
                                ...
                                if (isset($bank['data_bank_school']) && $bank['data_bank_school'] == $school_id):
                                    echo 'selected';
                                endif;
                ...
                <div id="bb">
                    <div class="form-group col-lg-6">
                        ...
                        <div class="form-group col-lg-3">
                            <label>Agência:</label>
                            <input disabled="disabled" type="text" id="agenciabb" class="form-control" placeholder="xxxx-x"  name="data_bank_agency" pattern="([0-9]{4})-[a-zA-Z0-9]{1}"  maxlength="6" value="<?php
                        ...
                        <div class="form-group col-lg-3">
                            <label>Conta:</label>
                            <input disabled="disabled" type="text" id="contabb" class="form-control" placeholder="xxxxxxxx-x"  name="data_bank_account"  pattern="([0-9]{8})-[a-zA-Z0-9]+{1}" maxlength="10" value="<?php
                    ...
                    <div id="cef">
                        <div class="form-group col-lg-6">
                            ...
                            <div class="form-group col-lg-2">
                                <label>Agência:</label>
                                <input disabled="disabled" type="text" id="agenciacef" class="form-control" placeholder="xxxx"  name="data_bank_agency" pattern=".{4}"  maxlength="4" value="<?php
                                if (isset($bank['data_bank_agency'])): echo $bank['data_bank_agency'];
                                endif;
                            ...
                            <div class="form-group col-lg-4">
                                ...
                                <input disabled="disabled" type="text" id="contacef" class="form-control" placeholder="xxxxxxxxxxx-x"  name="data_bank_account"  pattern="([0-9]{11})-[0-9]{1}" maxlength="13" value="<?php
                                if (isset($bank['data_bank_account'])): echo $bank['data_bank_account'];
                                endif;
