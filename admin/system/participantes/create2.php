        ...
        <div id="step1" class="p-m tab-pane active">
            <div class="row">
                ...
                <div class="form-group col-lg-6">
                    <label>Nome:</label>
                    <input type="text" class="form-control" name="participant_name" value="<?php if (isset($participant['participant_name'])): echo $participant['participant_name'];
                        endif;
                        ?>" required>
                </div>
                ...
                <div class="form-group col-lg-7">
                    <div class="form-group col-lg-4">
                        ...
                        <input type="text" class="form-control" name="participant_date_nascimento" id="nascimento" value="<?php if (isset($participant['participant_date_nascimento'])): echo $participant['participant_date_nascimento'];
                        endif;
                        ?>" required>
                    </div>
                    <div class="form-group col-lg-3">
                        <label>CPF:</label>
                        <input type="text" class="form-control" name="participant_cpf" id="cpf" value="<?php if (isset($participant['participant_cpf'])): echo $participant['participant_cpf'];
                        endif;
                        ?>" required>
                    </div>
                </div>
