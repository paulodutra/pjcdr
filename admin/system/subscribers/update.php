...
require_once('_models/AdminSubscribers.class.php');
	...
	if(!empty($subscribers) && isset($subscribers['sendSubscribers'])):
		...
		$createSubscriber->ExeUpdate($subscriberID,$subscribers);
		...
		$readSubscriber->ExeRead("cs_concurso_subscribers","WHERE subscribers_id=:id","id={$subscriberID}");

		if($readSubscriber->getResult()):
			$subscribers=$readSubscriber->getResult()[0];
		endif;	
    ...
    <div class="tab-content">
        ...
        <div id="step1" class="p-m tab-pane active">
            <div class="row">
            	<div class="form-group col-lg-10 ">
	              	<label>Concurso:</label>
	                	<select  class="form-control"  name="subscribers_concurso" required>
           ...
           <div class="text text-center">
            	<input type="submit" class="btn btn-success" name="sendSubscribers" value="Atualizar Inscrição"> 	
            </div>	
        </div>
    </div>
</form>            