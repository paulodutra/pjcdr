            ...
            <div class="row">
                ...
                <div class="form-group col-lg-5">
                    ...
                    <select  class="j_loadschool form-control"  name="subscribers_school" required>
                        ...
                        <?php
                        $readSchool = new Read;
                        $readSchool->ExeRead("es_school", "WHERE school_status=1 ORDER BY school_name ASC");
                ...
                <div class="form-group col-lg-3 ">
                    ...
                    <select  class="j_loadcategory form-control"  name="subscribers_category" required>
                        <option value="" selected> Selecione antes o Concurso</option>
                        <?php
                ...
                <div class="form-group col-lg-4">
                    ...
                    <select  class="j_loadseries form-control"  name="subscribers_series" required>
                        <?php if (!isset($subscribers['subscribers_category'])): ?>
                            ...
                            $readSeries = new Read;
                            $readSeries->FullRead("SELECT * FROM cs_category_series INNER JOIN cs_series ON category_series=series_id WHERE series_status=1 AND category_category={$subscribers['subscribers_category']} ORDER BY series_name");
