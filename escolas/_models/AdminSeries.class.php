...
*/
  public function ExeCreate(array $Data){
    ...
    elseif (!is_numeric($this->Data['series_number']) || $this->Data['series_number']<=0):
        $this->Result = false;
...
*/
  ...
  public function ExeUpdate($SeriesID, array $Data){
    ...
    elseif (!is_numeric($this->Data['series_number'])):
        $this->Result = false;
...
*/
  public function ExeDelete($SeriesID){
  	...
  	if(!$readSerie->getResult()):
    	...
    	$this->Result = true;
    	MSGErro("<b>Sucesso ao deletar:</b> A <b>Serie</b> foi excluida com sucesso !",MSG_ACCEPT);    
  	endif;	
