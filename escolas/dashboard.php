...
if (!$login->checkLogin()):
    ...
    $userSchool = $_SESSION['userloginSchool'];
            ...
            <nav role="navigation">
                ...
                <div class="navbar-right">
                    <ul class="nav navbar-nav no-borders">
                        ...
                        <li class="dropdown">
                            <a  href="<?= HOME ?>/escolas/dashboard.php?logoff=true">
            ...
            <div id="navigation">
                <div class="profile-picture">
                    ...
                    <div class="stats-label text-color">
                        <span class="font-extra-bold font-uppercase"><a href="<?= HOME ?>/escolas/dashboard.php"><?= $userSchool['school_name'] ?></a></span>                
                    </div>
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li <?php if (in_array('school', $linkto))  ?>> </a></li>
                ...
                <div class="hpanel">
                    <div class="panel-body">
                        ...
                        if (!empty($linkto[0]) || !empty($linkto[1])):
                            ...
                            $linkto[1] = ($linkto[1] == 'Create' ? 'Cadastrar' : ($linkto[1] == 'Update' ? 'Atualizar' : ( $linkto[1] == 'Index' ? 'Inicio' : ($linkto[1] == 'Profile' ? 'Perfil' : ($linkto[1] == 'File' ? 'Enviar Arquivo(s) de' : ($linkto[1] == 'Region' ? 'Região' : ($linkto[1] == 'Details' ? 'Detalhes' : ($linkto[1] == 'Details-region' ? 'Detalhes da Região de' : ($linkto[1] == 'Users' ? 'usuários' : ($linkto[1] == 'Terms' ? 'Termos' : $linkto[1] ))))))))));

                        else:
                            $linkto[0] = 'Area da Escola';
                            $linkto[1] = 'Inicio';
...
//QUERY STRING: Front Controller, irá decidir qual controlador será executado. A estrutura de navegação não entra dentro da pasta apena inclui as mesma atraves do parametro exe
    ...
    <script src="js/multiselectable.js" type="text/javascript"></script>


    <script>
        $(document).ready(function () {
            $('.multi').multiselectable({
                selectableLabel: 'Selecione as Categorias',
